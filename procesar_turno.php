...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $verificarAdmin = "select rol_id from personal p where id = '$personalID'";
    $resultadoVerificarAdmin = $conn->query($verificarAdmin);
    $row = $resultadoVerificarAdmin->fetch_assoc();
